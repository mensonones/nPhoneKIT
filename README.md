...
> Would you like to speed up me releasing updates? Simply fill out the form (you will be shown a link to it after an unlock if Contribution Suggestions is enabled.) ***after*** using nPhoneKIT!
...
> [!TIP]
> Watch easy-to-follow installation video [here!](https://youtu.be/hSK-dW2cTaY) 
